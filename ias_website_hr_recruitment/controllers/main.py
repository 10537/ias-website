...
class website_hr_recruitment(http.Controller):
    ...
    def jobs(self, country=None, department=None, office_id=None, **kwargs):
        ...
        # Render page
        return request.website.render("ias_website_hr_recruitment.index", {
            'jobs': jobs,
            'countries': countries,
    ...
    def jobs_detail(self, job, **kwargs):
        return request.render("ias_website_hr_recruitment.detail", {
            'job': job,
            'main_object': job,
        })
    ...
    def jobs_apply(self, job, **kwargs):
        ...
        return request.render("ias_website_hr_recruitment.apply", {
            'job': job,
            'error': error,
            'default': default,
        })
